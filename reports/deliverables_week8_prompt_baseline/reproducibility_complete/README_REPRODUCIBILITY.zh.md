...
本目录（相对仓库根）：`reports/deliverables_week8_prompt_baseline/reproducibility_complete`
对应周次：**Week 8**
...
- **服务端追溯目录（每次 Week 7/8 主流程自动发送 `X-Experiment-Trace-Dir`；可用 `--trace-dir` 改根路径）**：仓库内相对路径 `reports/deliverables_week8_prompt_baseline/reproducibility_logs/week8_20260507_074242`。
